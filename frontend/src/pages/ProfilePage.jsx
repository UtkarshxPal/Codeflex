...
import { AppleIcon, CalendarIcon, DumbbellIcon, Loader } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
    ...
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      ...
      {allPlans && allPlans?.length > 0 ? (
        <div className="space-y-8">
          ...
          {/* Plan Details */}
          {currentPlan && (
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6"></div>
          )}
          <CornerElements />
